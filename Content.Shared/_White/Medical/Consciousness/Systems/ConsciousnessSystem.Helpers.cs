...
public partial class ConsciousnessSystem
{
    ...
    public bool AddConsciousnessModifier(
        EntityUid target,
    ...
    /// <param name="type">Modifier type, defaults to generic</param>
    /// <returns>Successful</returns>
    public bool TryGetConsciousnessModifier(
        EntityUid target,
        EntityUid modifierOwner,
    ...
    /// <param name="type">Modifier type, defaults to generic</param>
    /// <returns>Successful</returns>
    public bool RemoveConsciousnessModifer(
        EntityUid target,
        EntityUid modifierOwner,
        ConsciousnessComponent? consciousness = null,
        ConsciousnessModType type = ConsciousnessModType.Generic)
    ...
    /// <param name="type">Modifier type, defaults to generic</param>
    /// <returns>Successful</returns>
    public bool UpdateConsciousnessModifierMetaData(
        EntityUid target,
        EntityUid modifierOwner,
    ...
    /// <returns>Successful</returns>
    public bool AddConsciousnessMultiplier(
        EntityUid target,
    ...
    /// <param name="type">Multiplier type, defaults to generic</param>
    /// <returns>Successful</returns>
    public bool TryGetConsciousnessMultiplier(
        EntityUid target,
        EntityUid multiplierOwner,
    ...
    /// <param name="consciousness">Consciousness component</param>
    /// <returns>Successful</returns>
    public bool RemoveConsciousnessMultiplier(
        EntityUid target,
        EntityUid multiplierOwner,
        ConsciousnessModType type = ConsciousnessModType.Generic,
        ConsciousnessComponent? consciousness = null)
    ...
    /// <param name="consciousness">Consciousness component</param>
    /// <returns>Successful</returns>
    public bool EditConsciousnessMultiplier(
        EntityUid target,
        EntityUid multiplierOwner,
    ...
    /// <param name="consciousness">Consciousness component</param>
    /// <returns>Successful</returns>
    public bool UpdateConsciousnessMultiplierMetaData(
        EntityUid target,
        EntityUid multiplierOwner,
        string newIdentifier,
        ConsciousnessComponent? consciousness = null,
